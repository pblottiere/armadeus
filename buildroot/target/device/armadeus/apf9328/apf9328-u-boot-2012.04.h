/*
 * Configuration settings for the Armadeus Project motherboard APF9328
 *
 * Copyright (C) 2005-2012 ej / Armadeus Project <eric.jarrige@armadeus.org>
 *
...
#define CONFIG_EXTRA_ENV_SETTINGS \
	...
	"addjffsargs=setenv bootargs ${bootargs} "			\
		"root=/dev/mtdblock5 rootfstype=jffs2\0"		\
